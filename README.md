...
این مستند، که شامل بیش از 7000 کلمه است، تمامی جنبه‌های فنی، نحوه کارکرد، راهنمای استفاده و جزئیات کامل سینتکس زبان Nexon را توضیح داده است. هدف از این مستند، فراهم آوردن راهنمایی جامع برای کاربرانی است که از ابتدا می‌خواهند با Nexon آشنا شوند و بتوانند پروژه‌های پیچیده و کاربردی را به راحتی توسعه دهند.
